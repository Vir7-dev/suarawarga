...
<body class="bg">
    ...
    <div class="container mb-5">
        <nav class="navbar navbar-expand-lg mt-2 mb-5">
            <div class="container d-flex justify-content-center flex-row">
                <a class="col-lg-7 col-8" href="#"><img src="../assets/img/logo1.png" width="40%" alt=""></a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                       <ul class="navbar-nav rounded-3 text-end my-4 p-4 gap-4 button-nav ms-auto mb-2 gap-2">
                        <li class="nav-item">
                            <a class="btn-hitam" href="profil.php">PROFIL KANDIDAT</a>
                        </li>
                        <li class="nav-item">
    ...
    <div class="container">
                                ...
                                <div class="col-lg-3 col-12">
                                    ...
                                    <div class="d-grid gap-2">
                                        <button class="btn-hitam" data-bs-toggle="modal"
                                            data-bs-target="#modal-pilih">PILIH</button>
                                    </div>
                                </div>
        ...
        <div class="modal fade" id="modal-pilih" tabindex="-1" aria-labelledby="pilih" aria-hidden="true">
